    ...
    <div>
        ...
        {filtered.map((item) => (
          ...
          >
            ...
            <div className="px-4 py-3 bg-gray-50/50 flex justify-between items-center border-t border-gray-100">
              <span className="text-[11px] text-gray-450 italic">Captured by: {item.photographer || "ASG"}</span>
      ...
      <Modal isOpen={modal.open && (modal.mode === "add" || modal.mode === "edit")} onClose={close} title={modal.mode === "add" ? "Create Timeline Log Entry" : "Modify Timeline Log"} size="lg">
        <div className="space-y-4">
          ...
          {/* Drag & Drop Multi Photo uploader */}
      ...
      <Modal isOpen={modal.open && modal.mode === "delete"} onClose={close} title="Confirm Timline Deletion" size="sm">
        <p className="text-xs text-gray-650">Are you sure you want to remove the log <strong>"{modal.item?.title}"</strong>?</p>
