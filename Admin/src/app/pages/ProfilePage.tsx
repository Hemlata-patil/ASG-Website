    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          style={{ background: saved ? "#10b981" : "#FF6B00", border: "none", cursor: "pointer", fontFamily: "'Satoshi', sans-serif", fontSize: "14px", boxShadow: saved ? "0 2px 10px rgba(16,185,129,0.35)" : "0 2px 10px rgba(255,107,0,0.35)", transition: "all 0.3s" }}>
        ...
        <div className="bg-white rounded-2xl p-6 flex flex-col items-center" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.06)", border: "1px solid #f0f0f0", height: "fit-content" }}>
          <div className="relative mb-5">
            ...
            <button
              ...
              style={{ background: "#0d0d0d", border: "2px solid #fff", cursor: "pointer" }}
            >
          ...
          <div className="bg-white rounded-2xl p-6" style={{ boxShadow: "0 1px 3px rgba(0,0,0,0.06)", border: "1px solid #f0f0f0" }}>
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-white font-semibold"
                style={{ background: pwSaved ? "#10b981" : "#0d0d0d", border: "none", cursor: "pointer", fontFamily: "'Satoshi', sans-serif", fontSize: "14px", transition: "all 0.3s" }}
              >
