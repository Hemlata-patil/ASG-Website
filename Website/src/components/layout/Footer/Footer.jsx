        ...
        <div className={styles.grid}>
          ...
          <div>
            ...
            <div className={styles.linksList}>
              ...
              <Link to="/aal" className={styles.footerLink}>AAL Internship</Link>
              <Link to="/asg" className={styles.footerLink}>ASG Community</Link>
              <Link to="/events" className={styles.footerLink}>Events & Meetups</Link>
              <Link to="/gallery" className={styles.footerLink}>Timeline Gallery</Link>
              <Link to="/about" className={styles.footerLink}>About APEX</Link>
              <Link to="/blogs" className={styles.footerLink}>Ecosystem Blogs</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className={styles.linksList}>
              <Link to="/events" className={styles.footerLink}>Monthly Meetups (22 Cohorts)</Link>
              <Link to="/events" className={styles.footerLink}>Breakfast with Brilliance (4 Cohorts)</Link>
              <Link to="/events" className={styles.footerLink}>AI Ki Choupal (2 Cohorts)</Link>
              <Link to="/events" className={styles.footerLink}>Startup Pe Charcha (2 Cohorts)</Link>
              <Link to="/events" className={styles.footerLink}>Apex AI Launchpad (2 Cohorts)</Link>
              <Link to="/events" className={styles.footerLink}>APEX Manthan (1 Cohort)</Link>
            </div>
          </div>
          ...
          <div>
            ...
            <div className={styles.linksList}>
              ...
              <Link to="/contact" className={styles.footerLink} style={{ color: 'var(--apex-primary)', fontWeight: '600' }}>Get In Touch →</Link>
            </div>
          </div>
        </div>
