...
/**
 * ApexDropdown — A custom, fully-styled dropdown built on Radix UI.
 * Uses the site's CSS custom properties. No Tailwind needed.
 *
 * Props:
 *   label     — currently selected option label (string)
 *   options   — array of { value, label }
 *   onSelect  — callback(value) when an option is clicked
 *   minWidth  — optional min-width for the content panel (default '180px')
 */
export default function ApexDropdown({ label, options = [], onSelect, minWidth = '180px' }) {
