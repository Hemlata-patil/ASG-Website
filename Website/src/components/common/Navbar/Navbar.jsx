...
export default function Navbar() {
  ...
  const [activeMobileDropdown, setActiveMobileDropdown] = useState(null); // 'communities' | 'highlights' | null
    ...
    <nav className={`${styles.navbar} ${scrolled ? styles.scrolled : ''}`}>
      <div className={styles.container}>
        ...
        <div className={styles.navLinks}>
          ...
          <div className={styles.dropdownContainer}>
            <div className={`${styles.navItem} ${communitiesItems.some(i => i.path === location.pathname) ? styles.activeNavItem : ''}`}>
            ...
            <div className={styles.dropdownMenu}>
              {communitiesItems.map(item => (
                <Link
                  key={item.label}
                  to={item.path}
                  className={`${styles.dropdownItem} ${location.pathname === item.path ? styles.activeDropdownItem : ''}`}
                >
                  {item.label}
                </Link>
              ))}
          ...
          {/* Highlights Dropdown */}
          <div className={styles.dropdownContainer}>
            <div className={`${styles.navItem} ${highlightsItems.some(i => i.path === location.pathname) ? styles.activeNavItem : ''}`}>
          ...
          <Link to="/about" className={`${styles.navItem} ${location.pathname === '/about' ? styles.activeNavItem : ''}`}>
            About
          </Link>
          <Link to="/contact" className={`${styles.navItem} ${location.pathname === '/contact' ? styles.activeNavItem : ''}`}>
            Contact
          </Link>
        </div>
        ...
        <div className={styles.ctas}>
          <button
            ...
            onMouseEnter={(e) => {
              ...
              e.target.style.boxShadow = 'var(--shadow-glow-orange)';
            }}
            onMouseLeave={(e) => {
      ...
      <div className={`${styles.mobileOverlay} ${mobileMenuOpen ? styles.mobileOverlayActive : ''}`}>
        <div className={styles.mobileNavLinks}>
          <Link to="/" className={styles.mobileNavItem} onClick={() => setMobileMenuOpen(false)}>
            Home
          </Link>
          ...
          <div className={styles.mobileNavItem} onClick={() => toggleMobileDropdown('communities')}>
            ...
            {activeMobileDropdown === 'communities' && (
              <div className={styles.mobileSubLinks}>
                {communitiesItems.map(item => (
                  <Link key={item.label} to={item.path} className={styles.mobileSubLink} onClick={() => setMobileMenuOpen(false)}>
                    {item.label}
                  </Link>
                ))}
              </div>
          ...
          <Link to="/about" className={styles.mobileNavItem} onClick={() => setMobileMenuOpen(false)}>
            About
          </Link>
          <Link to="/contact" className={styles.mobileNavItem} onClick={() => setMobileMenuOpen(false)}>
            Contact
          </Link>
        </div>
