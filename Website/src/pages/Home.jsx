...
export default function Home() {
  ...
  // Anime.js entrance animation on load
  useEffect(() => {
  ...
  const openLightbox = (entryIndex, imgIndex) => {
    setActiveEntryImages(galleryEntries[entryIndex].photos);
    ...
    <PageWrapper>
          ...
          <div style={{
            ...
            <div>
              ...
              <div style={{ display: 'flex', gap: 'var(--space-3)', flexWrap: 'wrap', marginBottom: 'var(--space-6)' }}>
                <Link to="/aal" className="btn hero-cta" style={{
                ...
                <Link to="/asg" className="btn hero-cta" style={{
            ...
            {/* Right Abstract Visual Graphic (Redesigned) */}
            <div className="hero-graphic" style={{
              ...
              {/* Rotating outer orbit and nodes */}
              ...
              {/* Static Central White Circle with Shadow and Border */}
              <div style={{
                position: 'relative',
                width: '240px',
                height: '240px',
              ...
              >
                {/* Custom static navigation compass arrowhead pointing Northwest */}
                <svg
                  width="70"
                  height="70"
                  viewBox="0 0 24 24"
      ...
      <section ref={statsRef} style={{
        ...
        <div className="container">
          <div style={{
            ...
            {/* Stat 1 */}
            <div>
              <div style={{ fontSize: '3rem', fontWeight: '800', color: 'var(--apex-primary)', fontFamily: 'Plus Jakarta Sans' }}>
                {cohortCount}
              </div>
      ...
      <section className="section" ref={splitAnim.ref} className={`section ${splitAnim.className}`}>
        <div className="container">
          <SectionHeading
            ...
            subtitle="APEX unifies startup growth circles and AI launchpad initiatives under a single collaborative ecosystem."
          />
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)' }} className="grid-2">
            ...
            <div style={{
              ...
              <Link to="/aal" style={{ color: 'var(--apex-primary)', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{
              ...
              <Link to="/asg" style={{ color: '#fff', fontWeight: '600', display: 'flex', alignItems: 'center', gap: '8px' }}>
        ...
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 'var(--space-5)' }}>
            <SectionHeading
              ...
              subtitle="Participate in hands-on workshops, networking meetups, and expert panels."
              align="left"
            />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 'var(--space-4)' }} className="grid-2">
            {(() => {
              ...
              const cohorts = events.filter(e => [1, 2].includes(e.id));
              const items = [...upcoming, ...cohorts];
      ...
      <section className="section" ref={galleryAnim.ref} className={`section ${galleryAnim.className}`}>
        <div className="container">
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', marginBottom: 'var(--space-5)' }}>
            <SectionHeading
              overline="Visual Timeline"
              title="Moments in the Ecosystem"
              subtitle="Take a look at snapshots of our past demo days, cohorts, and meetups."
              align="left"
            />
            ...
            {galleryEntries.slice(0, 3).map((entry, entryIndex) => (
              <div key={entry.id} style={{
                ...
                <div style={{ padding: 'var(--space-3)' }}>
                  ...
                  <p className="body-sm" style={{ color: 'var(--apex-text-muted)', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                    {entry.description}
                  </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 'var(--space-4)' }} className="grid-3">
            {blogs.slice(0, 3).map((blog) => (
              ...
              >
                ...
                {/* Article Info */}
                <div style={{ padding: 'var(--space-4)', flex: 1, display: 'flex', flexDirection: 'column', justifySelf: 'stretch', justifyContent: 'space-between' }}>
                  <div>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '1px solid var(--apex-border-dark)', paddingTop: '12px' }}>
                    ...
                    <Link to="/blogs" style={{ color: 'var(--apex-primary)', fontWeight: '600', fontSize: '0.85rem' }}>Read Article →</Link>
                  </div>
                </div>
              </article>
            ))}
      ...
      <section className="section" ref={testimonialsAnim.ref} className={`section ${testimonialsAnim.className}`} style={{ backgroundColor: 'var(--apex-bg-surface-elevated)' }}>
        <div className="container">
          <SectionHeading
            ...
            subtitle="Read real feedback from students, founders, and investors building in North Maharashtra."
          />
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 'var(--space-4)' }} className="grid-3">
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                <div style={{ width: '40px', height: '40px', borderRadius: '50%', background: 'var(--gradient-primary)', color: '#fff', display: 'flex', alignItems: 'center', justifySelf: 'center', justifyContent: 'center', fontWeight: 'bold' }}>
                  RK
                </div>
                <div>
      ...
      {/* Floating Vertical Social Handles */}
      <div style={{
        position: 'fixed',
        right: '20px',
        top: '50%',
        ...
        {/* Instagram */}
        <a
          href="https://www.instagram.com/apexstartupgroup"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'var(--apex-text-muted)', transition: 'color var(--transition-fast)' }}
          onMouseEnter={(e) => e.currentTarget.style.color = 'var(--apex-primary)'}
          onMouseLeave={(e) => e.currentTarget.style.color = 'var(--apex-text-muted)'}
        ...
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/company/apex-startup-group"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'var(--apex-text-muted)', transition: 'color var(--transition-fast)' }}
          onMouseEnter={(e) => e.currentTarget.style.color = 'var(--apex-primary)'}
        ...
        {/* X (Twitter) */}
        <a
          href="https://x.com/apexstartupgrp"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'var(--apex-text-muted)', transition: 'color var(--transition-fast)' }}
          onMouseEnter={(e) => e.currentTarget.style.color = 'var(--apex-primary)'}
        ...
        {/* YouTube */}
        <a
          href="https://youtube.com/@apexstartupgroup"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'var(--apex-text-muted)', transition: 'color var(--transition-fast)' }}
          onMouseEnter={(e) => e.currentTarget.style.color = 'var(--apex-primary)'}
        ...
        {/* WhatsApp */}
        <a
          href="https://chat.whatsapp.com/CoG7rugANv166E6p51uLcI"
          target="_blank"
          rel="noopener noreferrer"
          style={{ color: 'var(--apex-text-muted)', transition: 'color var(--transition-fast)' }}
          onMouseEnter={(e) => e.currentTarget.style.color = 'var(--apex-primary)'}
