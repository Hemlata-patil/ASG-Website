...
function GalleryContent() {
  ...
  const triggerLightbox = (photos: string[], index: number) => {
    ...
    <div className="container">
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          {['All', '2026', '2025', '2024', '2023', '2022', '2021', '2020', '2019'].map(year => (
            <button
              key={year}
      ...
      {/* Vercel-style Clean Changelog Timeline */}
      {filteredEntries.length > 0 ? (
        <div style={{
          ...
          <div style={{
            ...
            bottom: '10px',
            width: '2px',
            background: 'var(--apex-border-dark)',
            zIndex: 1
          }} />
          ...
          {filteredEntries.map((entry) => (
            ...
            >
              ...
              <div style={{
                ...
                zIndex: 2,
                boxShadow: '0 0 0 4px var(--apex-bg-base)'
              }} />
  ...
  return (
    <PageWrapper>
      <section className="section">
        <Suspense fallback={<div style={{ color: '#fff', textAlign: 'center' }}>Loading gallery timeline...</div>}>
          <GalleryContent />
        </Suspense>
      </section>
    </PageWrapper>
